...
describe AdsController do
  ...
  describe "GET show" do
    it "assigns the requested ad as @ad" do
      ad = Ad.create! valid_attributes
      get :show, {:id => ad.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested ad as @ad" do
      ad = Ad.create! valid_attributes
      get :edit, {:id => ad.to_param}, valid_session
      assigns(:ad).should eq(ad)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Ad" do
        expect {
          post :create, {:ad => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ad as @ad" do
        ...
        post :create, {:ad => { "user_id" => "invalid value" }}, valid_session
        assigns(:ad).should be_a_new(Ad)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ad" do
        ad = Ad.create! valid_attributes
        # Assuming there are no other ads in the database, this
        # specifies that the Ad created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Ad.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => ad.to_param, :ad => { "user_id" => "1" }}, valid_session
      end

      it "assigns the requested ad as @ad" do
        ad = Ad.create! valid_attributes
        put :update, {:id => ad.to_param, :ad => valid_attributes}, valid_session
        assigns(:ad).should eq(ad)
      end
      ...
      it "redirects to the ad" do
        ad = Ad.create! valid_attributes
        put :update, {:id => ad.to_param, :ad => valid_attributes}, valid_session
        response.should redirect_to(ad)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the ad as @ad" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ad.any_instance.stub(:save).and_return(false)
        put :update, {:id => ad.to_param, :ad => { "user_id" => "invalid value" }}, valid_session
        assigns(:ad).should eq(ad)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested ad" do
      ad = Ad.create! valid_attributes
      expect {
        delete :destroy, {:id => ad.to_param}, valid_session
      }.to change(Ad, :count).by(-1)
    end
